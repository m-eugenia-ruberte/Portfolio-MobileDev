...
class ReplyAppStateRestorationTest {
    /**
     * Note: To access to an empty actvity, the code uses ComponentActivity
    ...
    fun compactDevice_selectedEmailEmailRetained_afterConfigChange(){
        ...
        val statateRestorationTester = StateRestorationTester(composeTestRule)
        statateRestorationTester.setContent {
        ...
        statateRestorationTester.emulateSavedInstanceStateRestore()
